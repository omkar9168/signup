...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Omkar's Developer</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Omkar's Developer</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://qualitysoftech.com/java-training/"> <i
					class="fas fa-download me-2"></i> Course Overview
				</a>
			</div>
		</div>
	</section>
						...
						<div class="d-none" id="submitSuccessMessage">
							<div class="text-center mb-3">
								...
								To activate this form, sign up at <br /> <a
									href="https://qualitysoftech.com/contacts/">https://sthttps://qualitysoftech.com/contacts/</a>
							</div>
						</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						NEAR REGENCY HOTEL, NEAR THANE RAILWAY STATION <br /> THANE
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Classes</h4>
					<p class="lead mb-0">
						Quality Software Technologies - Java Full-Stack Course <a href="https://qualitysoftech.com/">Start Course</a> .
					</p>
				</div>
			</div>
		</div>
