...
<title>Sign Up Form by QST</title>
        ...
        <div class="container">
            <div class="signin-content">
                <div class="signin-image">
                    <figure>
                        <img src="<%= request.getContextPath() %>/images/signin-image.jpg" alt="sign up image">
                    </figure>
                    <a href="<%= request.getContextPath() %>/registration.jsp" class="signup-image-link">Create an account</a>
                </div>
